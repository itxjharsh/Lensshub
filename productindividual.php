...
<body>
    ...
    <?php
        ...
        <div class="left-column">
            <img data-image="red" class="active" src="Glass-'.$row['specs_id'].'.jpg" alt="" style=" width:520px">
        </div>
            ...
            if($_SESSION['loggedin']){
                ...
                while($row1 = mysqli_fetch_assoc($result4)){
                    ...
                    echo '<div class="media">
                            <img src="user-3296.png" class="mr-3" alt="..." width = "34px">
                ...
                echo '<a href="login.html" style = "font-size: 25px;">Login</a><p> to review this product!!</p>';
