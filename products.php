        ...
        while($row=mysqli_fetch_assoc($result1)){
            ...
            <div class="card" style = "background-color: none">
              <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                ...
                <img src="Glass-'.$row['specs_id'].'.jpg"
                  class="w-100" />
                <a href="#!">
                  <div class="mask">
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <p>
                            <a href="store.html" class="text-reset">Stores</a>
                        </p>
                        <p>
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <!-- Instagram -->
                        <a class="btn btn-link btn-floating btn-lg text-light m-1" href="https://www.instagram.com/lensshub/" role="button"
                            data-mdb-ripple-color="light"><i class="fa fa-instagram"></i></a>

                        <!-- Linkedin -->
                        <a class="btn btn-link btn-floating btn-lg text-light m-1" href="https://www.linkedin.com/posts/harsh-jain-b1aaba269_frontenddevelopment-fullstackdeveloper-backenddeveloper-activity-7054060451113906177-s1aL?utm_source=share&utm_medium=member_desktop" role="button"
                            data-mdb-ripple-color="light"><i class="fa fa-linkedin"></i></a>
                        <!-- Github -->
                        <a class="btn btn-link btn-floating btn-lg text-light m-1" href="https://github.com/itxjharsh/Lensshub" role="button"
