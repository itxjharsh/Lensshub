...
<body>
    ...
    <div class="container-2">
        ...
        <div class="boxes-c2" id="box-4">Experience the clearity in your <br> <span style="color:grey;">वि-SION.</span>
            ...
            <?php
            if($_SESSION['loggedin']){
                echo '<button id = "mb"><a href="products.php">Browse Products</a></button>';
            }
            else{
                echo '<button id = "mb"><a href="signup.html">SIGN-UP</a>
                </button>';
            }
            ?>
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <!-- Github -->
                        <a class="btn btn-link btn-floating btn-lg text-light m-1"
                            href="https://github.com/itxjharsh/Lensshub" role="button"
